...
namespace Recommender.Core.Engine
{
	...
	public class FeaturedRatingsProxy : FeaturedRatings
	{
		...
		public FeaturedRatingsProxy(IFeaturedRatings ratings, IList<int> indices)
		{
			...
			Features  = new ListProxy<IList<IFeature>>(ratings.Features, indices);
